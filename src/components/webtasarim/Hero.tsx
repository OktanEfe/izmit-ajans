  ...
  return (
    <section className="h-screen flex flex-col items-center justify-center text-center px-6 pt-24 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none z-0">
        <motion.div
          animate={isTouch ? undefined : { x: [0, -40, 20, 0], y: [0, 30, -40, 0], scale: [1, 1.1, 0.92, 1] }}
        ...
        />
        <motion.div
          animate={isTouch ? undefined : { x: [0, 35, -25, 0], y: [0, -40, 20, 0], scale: [1, 0.94, 1.1, 1] }}
        ...
        />
        <motion.div
          animate={isTouch ? undefined : { x: [0, -20, 30, 0], y: [0, 35, -15, 0], scale: [1, 1.06, 0.96, 1] }}
