...
const calismalar = [
  {
    marka: "EF Sanal Ofis",
    tur: "Kurumsal Web Sitesi",
    aciklama: "Modern tasarım, hızlı yükleme ve mobil uyumlu kurumsal web sitesi.",
    href: "https://efsanalofis.com",
  },
  {
    marka: "Sommario",
    tur: "E-Ticaret",
    aciklama: "Ürün kataloğu, ödeme entegrasyonu ve özel yönetim paneli.",
    href: "https://sommario.com.tr",
  },
  {
    marka: "Lion Hotel Çınarcık",
    tur: "Landing Page",
    aciklama: "Yüksek dönüşüm odaklı tasarım, animasyonlar ve SEO optimizasyonu.",
    href: "https://lionhotelcinarcik.com",
  },
];
